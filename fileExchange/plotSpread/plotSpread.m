...
if opt.showMM
    ...
    switch opt.xyOri
        case 'normal'
            ...
            if opt.showMM == 4
                mh = plot(ah,opt.xValues,m,'sr','Color','r','MarkerSize',12,'LineWidth',2);
                mdh = myErrorbar(ah,opt.xValues,m,sem);
            end
            if opt.showMM == 5
                mh = plot(ah,opt.xValues,m,'sr','Color','r','MarkerSize',12);
        ...
        case 'flipped'
            ...
            if opt.showMM == 4
                mh = plot(ah,m,opt.xValues,'sr','Color','r','MarkerSize',12);
